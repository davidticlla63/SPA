...
@Named(value = "facturaLisPizzeriaController")
@SuppressWarnings("serial")
@ConversationScoped
public class FacturaLisPizzeriaController implements Serializable {
	...
	Logger log = Logger.getLogger(FacturaLisPizzeriaController.class);
