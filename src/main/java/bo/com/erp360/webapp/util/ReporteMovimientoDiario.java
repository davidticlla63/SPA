...
@WebServlet("/ReporteMovimientoDiario")
public class ReporteMovimientoDiario extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			if (pEstado.doubleValue()==1) {
				 rutaReporte = urlPath
							+ "resources/report/Venta/reportVentaDiariaDetallado.jasper";
			}
			if (pEstado.doubleValue()==2) {
				 rutaReporte = urlPath
							+ "resources/report/Venta/reportVentaDiariaDetalladoAgrupado.jasper";
			}
			if (pEstado.doubleValue()==3) {
				 rutaReporte = urlPath
							+ "resources/report/Venta/reportVentaPlanillaSueldos.jasper";
			}
			if (pEstado.doubleValue()==4) {
				 rutaReporte = urlPath
							+ "resources/report/Venta/reportVentaDiariaPorOrden.jasper";
			}
